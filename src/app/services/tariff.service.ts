...
export class TariffService {
  ...
  getTariffData(){
    return [
      ...
      {company: 'aircel+', speed: 12, downspeed: 32, tariff: [ 'a tariff: 1','b tariff: 2','c tariff: 3'], price: 34.99},
      ...
      {company: 'allnet', speed: 150, downspeed: 2, tariff: [ 'a tariff: 1','b tariff: 2','c tariff: 3'], price: 76.99},
      {company: 'infinity', speed: 69, downspeed: 11, tariff: [ 'a tariff: 1','b tariff: 2','c tariff: 3'], price: 87.99},
